  ...
  <NuxtLink :to="withLocale(to)" class="card tool-card">
    <div class="tool-card-header">
      ...
      <div class="tool-meta">
        ...
        <span v-if="badge" :class="['pill', badge === 'popular' ? 'popular' : 'new']">
    ...
    <div class="cc-footer">
      <UiButton variant="outline" :to="withLocale(to)" full>{{ t('tool.use') }}</UiButton>
    </div>
  </NuxtLink>
</template>
...
const defaultBadgeLabel = computed(() => props.badge === 'popular' ? t('badge.popular') : t('badge.new'))
const badgeLabel = computed(() => props.badgeLabelOverride || defaultBadgeLabel.value)
