    ...
    <div class="container footer-grid">
        ...
        <div class="brand" aria-label="SuperTool">
          ...
          <div>
            <div class="brand-name">
              SuperTool <span class="brand-tld">.digital</span>
            </div>
          </div>
        </div>
        <p class="helper mt-8">
      ...
      <div>
        ...
        <ul class="helper">
          ...
          <li>
            <NuxtLink :to="withLocale('/todas-as-ferramentas')"
              >Todas as Ferramentas</NuxtLink
            >
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="helper">
          ...
          <li>
            <NuxtLink :to="withLocale('/reportar-bug')">Reportar Bug</NuxtLink>
          </li>
          <li>
            <NuxtLink :to="withLocale('/privacidade')">Privacidade</NuxtLink>
          </li>
        </ul>
      </div>
    </div>
