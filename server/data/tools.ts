...
export default [
  {
    ...
    description: {
      ...
      "pt-br":
        "Converta texto, imagens e arquivos para Base64 e vice-versa de forma rápida e segura.",
  ...
  },
  {
    ...
    description: {
      ...
      "pt-br":
        "Gere códigos QR personalizados para URLs, textos e dados diversos.",
    ...
    badges: [
      {
        type: "new",
        color: "green",
        title: { en: "New", "pt-br": "Novo", es: "Nuevo" },
      },
    ],
    keywords: ["qr", "code"],
  },
  {
    ...
    description: {
      ...
      "pt-br":
        "Decodifique e analise tokens JWT para debug e validação de autenticação.",
    ...
    badges: [
      {
        type: "popular",
        color: "blue",
        title: { en: "Popular", "pt-br": "Famosinho", es: "Popular" },
      },
    ],
  ...
  },
  {
    ...
    description: {
      ...
      "pt-br":
        "Formatar, validar e minificar seus arquivos JSON com syntax highlighting.",
  ...
  },
  {
    ...
    description: {
      ...
      "pt-br":
        "Crie paletas de cores harmoniosas para seus projetos de design.",
